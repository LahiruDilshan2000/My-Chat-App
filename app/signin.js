        ...
        <View className="flex-1">
            ...
            <View style={{paddingTop: hp(10), paddingHorizontal: 15}} className={"flex gap-12"}>
                ...
                <View className="gap-10">
                    <Text style={{fontSize: hp(4)}} className={"font-bold tracking-wider text-center text-neutral-800"}>Sign
                        In</Text>
                </View>
                <View className="gap-4">
                            ...
                            loading ? (
                                ...
                                (
                                    <TouchableOpacity
                                        ...
                                        <Text style={{fontSize: hp(2.7)}} className={"text-white font-bold tracking-wider"}>Sign
                                            In</Text>
                                    </TouchableOpacity>
                                )
                        }
                    ...
                    <View className={"flex-row justify-center"}>
                        <Text style={{fontSize: hp(1.8)}} className={"font-semibold text-neutral-400"}>Don't have and
                            account? </Text>
